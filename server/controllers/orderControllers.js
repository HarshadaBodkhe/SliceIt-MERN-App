                  ...
                  if (createdOrder) {
                    ...
                    if (user && user.email) {
                      ...
                      const emailBody = `
                        ...
                        <p>Delivery Address: ${deliveryAddress.address}, ${deliveryAddress.city}, ${deliveryAddress.postalCode
      ...
      if (user && user.email) {
        await sendEmail({
          ...
          templateOptions: {
            ...
            greeting: `Hi ${user.name || ''},`,
            message: `Your order <b>${order._id}</b> has been delivered!<br><br>We hope you enjoy your meal. Thank you for choosing SliceIt!`,
          },
        });
      }
    } else {
