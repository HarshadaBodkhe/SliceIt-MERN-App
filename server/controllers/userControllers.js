...
const getAllUsers = asyncHandler(async (req, res) => {
  // Populate orders to get the actual array
  // const users = await User.find({}).populate('orders', '_id'); // 'orders' is your field name in schema
...
//   // Transform users to include numberOfOrders
//   const usersWithOrders = users.map((user) => ({
//     _id: user._id,
//     name: user.name,
//     email: user.email,
//     isVerified: user.isVerified,
//     numberOfOrders: user.orders ? user.orders.length : 0,
//   }));
