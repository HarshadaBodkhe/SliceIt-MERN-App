  ...
  <>
    <section className="min-h-screen flex flex-col sm:flex-row justify-center items-center pt-16 px-5 sm:px-16 space-y-5 sm:space-y-0 sm:space-x-5">
      {loading || orderLoading ? (
        ...
        userDetails && (
          <>
            <div className="flex flex-col justify-center items-center p-4 rounded-2xl w-full sm:w-1/3 border border-[#0B3D91]">
              ...
              {!isEditing && (
                <Button
                  variant="primary"
                  className="rounded-lg bg-[#E31837] hover:bg-[#0B3D91] text-white transition duration-200"
            ...
            <div className="flex flex-col justify-center items-center w-full sm:w-2/3">
              {orderListByUserId.length > 0 ? (
                <>
                  <h1 className="text-2xl font-bold text-center mb-4 text-[#0B3D91]">
                    My Orders
                  </h1>
                  <UserOrdersTable orders={orderListByUserId} />
                </>
              ) : (
                <div className="w-full text-4xl text-center font-bold text-[#E31837] border-2 border-[#0B3D91] rounded-2xl p-4">
                  No Orders Found!
                </div>
              )}
            </div>
